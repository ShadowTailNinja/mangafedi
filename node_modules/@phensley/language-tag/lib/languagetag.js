...
exports.LanguageTag = exports.LanguageTagField = void 0;
/**
 * @public
 */
var LanguageTagField;
(function (LanguageTagField) {
    LanguageTagField[LanguageTagField["LANGUAGE"] = 0] = "LANGUAGE";
    LanguageTagField[LanguageTagField["SCRIPT"] = 1] = "SCRIPT";
    LanguageTagField[LanguageTagField["REGION"] = 2] = "REGION";
    LanguageTagField[LanguageTagField["VARIANT"] = 3] = "VARIANT";
})(LanguageTagField || (exports.LanguageTagField = LanguageTagField = {}));
var SEP = '-';
var UNDEFINED_VALUES = ['und', 'Zzzz', 'ZZ', ''];
var KEYS = [LanguageTagField.LANGUAGE, LanguageTagField.SCRIPT, LanguageTagField.REGION, LanguageTagField.VARIANT];
var TRANSFORMS = [
...
var LanguageTag = /** @class */ (function () {
    ...
    LanguageTag.prototype.render = function (expanded) {
        ...
        KEYS.forEach(function (key) {
            var force = key !== LanguageTagField.VARIANT && (key === LanguageTagField.LANGUAGE || expanded);
