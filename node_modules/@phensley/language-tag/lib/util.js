...
var substituteRegionAliases = function (dst) {
    ...
    var region = dst[languagetag_1.LanguageTagField.REGION];
    var replacement = region === languagetag_1.LanguageTagField.REGION ? undefined : TERRITORY_ALIAS_MAP[region];
    if (replacement === undefined) {
        return;
    }
    // Hack: for now we just use the first region in the list.
    dst[languagetag_1.LanguageTagField.REGION] = replacement[0];
