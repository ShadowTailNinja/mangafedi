...
import { deno_default, getDocumentLoader, kvCache } from "./docloader-BRNFZnTb.js";
import { Activity, Collection, CollectionPage, CryptographicKey, Link, Multikey, Object as Object$1, OrderedCollection, OrderedCollectionPage, getTypeId } from "./actor-jvzet8bO.js";
import { lookupWebFinger } from "./lookup-CKEj5FWO.js";
import { exportJwk, importJwk, validateCryptoKey } from "./key-gldrk_5Z.js";
import { doubleKnock, verifyRequest } from "./http-C3_5amY1.js";
import { detachSignature, doesActorOwnKey, getKeyOwner, hasSignature, signJsonLd, signObject, verifyJsonLd, verifyObject } from "./proof-Bx8lj3_m.js";
import { getNodeInfo, nodeInfoToJson } from "./types-BsFw6XaG.js";
import { getAuthenticatedDocumentLoader } from "./authdocloader-Ddqc8DWD.js";
import { lookupObject, traverseCollection } from "./vocab-qsTMTRUj.js";
...
var FederationBuilderImpl = class {
	...
	*/
	...
	async build(options) {
		const { FederationImpl: FederationImpl$1 } = await import("./middleware-CiCT_xe3.js");
