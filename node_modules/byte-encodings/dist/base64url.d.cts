 ...
 * ```
 */
declare function encodeBase64Url(data: ArrayBuffer | Uint8Array | string): string;
/**
 ...
 * ```
 */
declare function decodeBase64Url(b64url: string): Uint8Array_;

export { Uint8Array_, decodeBase64Url, encodeBase64Url };
