 ...
 * ```
 */
declare function encodeBase58(data: ArrayBuffer | Uint8Array | string): string;
/**
 ...
 * ```
 */
declare function decodeBase58(b58: string): Uint8Array_;

export { Uint8Array_, decodeBase58, encodeBase58 };
