...
import { B as Base32Options } from './_common32-CO50UDr6.cjs';
export { a as Base32Alphabet, c as calcSizeBase32 } from './_common32-CO50UDr6.cjs';
 ...
 * ```
 */
declare function encodeBase32(input: string | Uint8Array_ | ArrayBuffer, options?: Base32Options): string;
/**
 ...
 * ```
 */
declare function encodeIntoBase32(input: string | Uint8Array_ | ArrayBuffer, output: Uint8Array_, options?: Base32Options): number;
/**
 ...
 * ```
 */
declare function decodeBase32(input: string | Uint8Array_, options?: Base32Options): Uint8Array_;

export { Base32Options, Uint8Array_, decodeBase32, encodeBase32, encodeIntoBase32 };
