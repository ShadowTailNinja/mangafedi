...
interface EncodeAscii85Options {
    /**
 ...
 * ```
 */
declare function encodeAscii85(data: ArrayBuffer | Uint8Array | string, options?: EncodeAscii85Options): string;
/** Options for {@linkcode decodeAscii85}. */
type DecodeAscii85Options = Omit<EncodeAscii85Options, "delimiter">;
/**
 ...
 * ```
 */
declare function decodeAscii85(ascii85: string, options?: DecodeAscii85Options): Uint8Array_;

export { type Ascii85Standard, type DecodeAscii85Options, type EncodeAscii85Options, Uint8Array_, decodeAscii85, encodeAscii85 };
