 ...
 * ```
 */
declare function decodeVarint(buf: Uint8Array, offset?: number): [bigint, number];
/**
 ...
 * ```
 */
declare function decodeVarint32(buf: Uint8Array, offset?: number): [number, number];
/**
 ...
 * ```
 */
declare function encodeVarint(num: bigint | number, buf?: Uint8Array, offset?: number): [Uint8Array_, number];

export { MaxUint64, MaxVarintLen32, MaxVarintLen64, Uint8Array_, decodeVarint, decodeVarint32, encodeVarint };
